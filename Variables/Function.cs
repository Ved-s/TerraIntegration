...
namespace TerraIntegration.Variables
{
    public class Function : Variable, IProgrammable
    {
        ...
        public override string TypeDefaultDescription => "Computes a new value based on given arguments";

        public override SpriteSheetPos SpriteSheetPos => new(BasicSheet, 1, 3);

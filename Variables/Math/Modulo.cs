...
namespace TerraIntegration.Variables.Numeric
{
    public class Modulo : DoubleReferenceVariable
    {
        ...
        public override ValueMatcher LeftSlotValueTypes => ValueMatcher.OfType<IModulable>();
        ...
        public override ValueMatcher GetValidRightSlotTypes(ReturnValue? leftSlotReturn)
        {
            ...
            return leftSlotReturn.Value.GetInstanceInterface<IModulable>()?.ValidModuloTypes ?? ValueMatcher.MatchNone;
        }
